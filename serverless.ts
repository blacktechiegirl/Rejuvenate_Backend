...
import {createProduct, getAllProducts, getProductByCategory, getProductById , generateUploadURL, getAllCartItems,getRelatedItems, createCartItem,updateQuantity, deleteCartItem,getAllWishlistItems, createWishlistItem, deleteWishlistItem } from '@functions/index';
...
const serverlessConfiguration: AWS = {
  ...
  functions: {createProduct, getAllProducts,updateQuantity, getProductByCategory, getProductById , generateUploadURL,getAllCartItems,getRelatedItems, createCartItem, deleteCartItem,getAllWishlistItems, createWishlistItem, deleteWishlistItem },
